/**
 * Convierte la configuración del listado en los datos devueltos
 * @param  {object} options JSON con la configuración, debe contener al menos dos claves: src (con la definicion del listado) y div (el id del elemento enq ue se renderizará el listado.)
